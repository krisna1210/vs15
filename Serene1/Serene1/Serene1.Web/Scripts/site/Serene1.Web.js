...
(function (Serene1) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', Serene1.Northwind.CustomerEditor], ['OrderDate', Serenity.DateEditor], ['CategoryID', Serenity.LookupEditor], ['DetailList', BasicSamples.FilteredLookupDetailEditor]].forEach(function (x) { return FilteredLookupInDetailForm.prototype[x[0]] = function () { return this.w(x[0], x[1]); }; });
    })(BasicSamples = Serene1.BasicSamples || (Serene1.BasicSamples = {}));
})(Serene1 || (Serene1 = {}));
var Serene1;
(function (Serene1) {

...
namespace Serene1.Northwind
{
    public partial class OrderForm : PrefixedContext
    {
        ...
        public CustomerEditor CustomerID { [InlineCode("{this}.w('CustomerID', Serene1.Northwind.CustomerEditor)")] get; private set; }
        ...
        public OrderDetailsEditor DetailList { [InlineCode("{this}.w('DetailList', Serene1.Northwind.OrderDetailsEditor)")] get; private set; }

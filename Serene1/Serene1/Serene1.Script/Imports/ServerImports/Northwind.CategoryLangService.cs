...
namespace Serene1.Northwind
{
    ...
    {
        [InlineConstant]
        public const string BaseUrl = "Northwind/CategoryLang";
        ...
        {
            [InlineConstant]
            public const string Create = "Northwind/CategoryLang/Create";
            [InlineConstant]
            public const string Update = "Northwind/CategoryLang/Update";
            [InlineConstant]
            public const string Delete = "Northwind/CategoryLang/Delete";
            [InlineConstant]
            public const string Retrieve = "Northwind/CategoryLang/Retrieve";
            [InlineConstant]
            public const string List = "Northwind/CategoryLang/List";
        }
    }
}

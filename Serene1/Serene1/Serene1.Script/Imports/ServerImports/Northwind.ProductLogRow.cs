...
namespace Serene1.Northwind
{
    ...
    {
        [InlineConstant]
        public const string IdProperty = "ProductLogID";
        [InlineConstant]
        public const string LocalTextPrefix = "Northwind.ProductLog";
        ...
        {
            [InlineConstant]
            public const string ProductLogID = "ProductLogID";
            [InlineConstant]
            public const string OperationType = "OperationType";
            [InlineConstant]
            public const string ChangingUserId = "ChangingUserId";
            [InlineConstant]
